...
public class DatabaseInitController {
    ...
    public String initTables() {
        ...
        try {
            ...
            result.append("user_followers: ").append(e.getMessage()).append("\n");
        }
        ...
        try {
            ...
            result.append("user_followings: ").append(e.getMessage()).append("\n");
        }
        ...
        try {
            ...
            result.append(" users_saved_post: ").append(e.getMessage()).append("\n");
        }
